...
namespace Modules\Incometax\Http\Controllers\Backend;
...
class IncometaxesController extends BackendBaseController
{
    use Authorizable;
    ...
    public function __construct()
    {
        ...
        $this->module_path = 'incometax::backend';

        // module icon
        $this->module_icon = 'fa-regular fa-sun';

        // module model name, path
        $this->module_model = "Modules\Incometax\Models\Incometax";
    }
