...
namespace Modules\Td\Http\Controllers\Backend;
...
class TdsController extends BackendBaseController
{
    use Authorizable;
    ...
    public function __construct()
    {
        ...
        $this->module_path = 'td::backend';

        // module icon
        $this->module_icon = 'fa-regular fa-sun';

        // module model name, path
        $this->module_model = "Modules\Td\Models\Td";
    }
